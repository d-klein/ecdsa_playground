...
class TestECCProjective():
    ...
    def testScalarMultiplication(self):
        ...
        # compute n * bp
        bp = ecc.aff2pro(ecc.pro2aff(ecc.proBasePoint), 42)
        BPmul = ecc.scalarMult(112233445566778899, bp)
        ...
        # compute n * bp
        bp = ecc.aff2pro(ecc.pro2aff(ecc.proBasePoint), 42)
        BPmul = ecc.scalarMult(29852220098221261079183923314599206100666902414330245206392788703677545185283, bp)
